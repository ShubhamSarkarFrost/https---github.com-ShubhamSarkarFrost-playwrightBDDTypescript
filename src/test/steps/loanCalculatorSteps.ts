...
When(
  'User enter the autoprice as {string} loanterm as {string} interestrate as {string} cashincentive as {string} downpayment as {string} tradein as {string} amountowed as {string} userstate as {string} tax as {string} and othertax as {string}',
  async function (
    autoprice: string,
    loanterm: string,
    interestrate: string,
    ...
    await autoLoanCalculatorPage.enterLoanDetails(
      autoprice,
      loanterm,
      interestrate,
      cashincentive,
