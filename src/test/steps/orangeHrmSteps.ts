...
When('I enter usersname as {string} in Username textbox', async function (NameOfUser:string) {
...
When('I reconfirm the password as {string}', async function (reconfirmPassword:string) {
